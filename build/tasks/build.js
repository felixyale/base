...
module.exports = function(grunt) {
  ...
  function convert(name, path, contents) {
    ...
    if ((amdName = grunt.option('amd')) !== null && /^exports\/amd$/.test(name)) {
      if (amdName) {
        grunt.log.writeln('Naming base with AMD name: ' + amdName);
      } else {
      ...
      contents = contents
        .replace(/(\s*)'base'(\,\s*)/, amdName ? '$1\'' + amdName + '\'$2' : '');
    }
  ...
  grunt.registerMultiTask(
    ...
    function() {
      ...
      var removeWith = this.data.removeWith;
      var excluded = [];
      var included = [];
  ...
  grunt.registerTask('custom', function() {
    var args = this.args;
    var modules = args.length ? args[0].replace(/,/g, ':') : '';
